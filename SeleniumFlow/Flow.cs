...
namespace SeleniumFlow
{
    ...
    {
        public static FlowContext<SeleniumState> CreateContext(Browser browser, System.Uri uri)
        {
            if (uri == null)
            {
            ...
            try
            {
                ...
                return FlowContext.FromDriver(driver);
            }
            catch (Exception x)
            {
                return new FlowContext(null, null, null, x);
            }
        }
